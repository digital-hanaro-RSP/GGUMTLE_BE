...
// 		when(bucketService.createBucket(any(BucketRequestDto.CreateBucket.class), any(), any())).thenReturn(
// 			responseDto);
//
...
//
// 		// then
// 		verify(bucketService).createBucket(any(BucketRequestDto.CreateBucket.class), any(), any());
// 	}
//
// 	@Test
...
// 		CustomUserDetails mockUser = mock(CustomUserDetails.class);
// 		when(mockUser.getUser()).thenReturn(new User());
// 		given(bucketService.updateBucket(eq(bucketId), any(BucketRequestDto.CreateBucket.class)))
